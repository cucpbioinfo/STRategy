...
public class SequenceUtils {
    public static List<String> convertSeqStringToList(String seq) {
...
//    public static List<MotifDto> convertSeqStringToMotif(String seq) {
...
//    }
    ...
    public static List<PatternAlignmentMotif> convertSeqStringToMotif(String seq) {
        List<String> stringList = Arrays.stream(seq.split(" ")).filter(e -> !e.equals("")).collect(Collectors.toList());
