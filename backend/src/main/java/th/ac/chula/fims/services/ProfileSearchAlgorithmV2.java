...
@Service("v2ProfileSearchAlgorithm")
public class ProfileSearchAlgorithmV2 implements ProfileSearchAlgorithm {

    private final ProfileSearchLocusRepository profileSearchLocusRepository;
    private final CountryRepository countryRepository;
    private final ConfigurationRepository configurationRepository;

    public ProfileSearchAlgorithmV2(ProfileSearchLocusRepository profileSearchLocusRepository, CountryRepository countryRepository, ConfigurationRepository configurationRepository) {
