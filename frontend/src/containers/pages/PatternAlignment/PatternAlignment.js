          ...
          items={[
            {
              key: '1',
              label: (
                  <a onClick={() => setIsReverse(prev => !prev)} rel="toggle sequence" href="#">
                    Toggle Sequence
                  </a>
              ),
            }
  ...
  return (
      <div>
        ...
        {result.length > 0 &&
            <Row style={{marginTop: "45px"}} justify="center">
              <PageHeader
                  ...
                  subTitle={PatternAlignmentUtils.getPatternAlignmentByAlleles(referenced.patternAlignmentAlleles, currentAllele)}
        ...
        <Row style={{marginTop: "15px"}} justify="center">
          <Col span={23}>
            {result.length > 0 &&
                <AlignmentEntry reverse={isReverse} currentLocus={currentLocus} setCurrentMenu={props.setCurrentMenu}
                                data={result}/>}
          </Col>
        </Row>
      </div>
