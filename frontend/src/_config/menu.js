...
import {ADMIN_ROLE, GUEST_ROLE, LAB_USER_ROLE, USER_ROLE} from "./constants";

const menus = [
  {
    name: "Home",
    key: "Home",
    roles: [GUEST_ROLE, USER_ROLE, LAB_USER_ROLE, ADMIN_ROLE],
  ...
  },
  {
    ...
    submenuGroup: [
      ...
      },
      {
        ...
        menus: [
          {
            title: "Referenced STR repeat structure patterns",
      ...
      },
      {
        ...
        menus: [
          ...
          {
            title: "Statistic Profile Database",
  ...
  },
  {
    name: "My profile",
    key: "my-profile",
    roles: [USER_ROLE, LAB_USER_ROLE, ADMIN_ROLE],
    link: null,
    icon: UserOutlined,
    submenuGroup: [
      {
